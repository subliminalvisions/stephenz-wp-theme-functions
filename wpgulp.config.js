 ...
 */
 ...
 module.exports = {
	...
	// Project options.
	projectURL: 'wpshbase.docker.localhost:8000', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	// port: 8000, //
	...
	// Translation options.
	textDomain: 'WPGT', // Your textdomain here.
	translationFile: 'WPGULP.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'QsConsumer', // Package name.
	bugReport: 'https://www.newtarget.com/', // Where can users report bugs.
	lastTranslator: 'NewTarget <hosted@newtarget.com', // Last translator Email ID.
	team: 'NewTarget <hosted@newtarget.com>', // Team's Email ID.
